...
boards 안에 templates 폴더 만들기

boards - templates 폴더 안에 boards 폴더 만들기

boards - templates - boards 폴더 안에 index.html 파일 생성 후 코드 작성
...
사용자가 입력하는 페이지 : new.html

boards - templates - boards - new.html 코드 작성 
...
사용자가 수정하는 페이지 : edit.html

boards - templates - boards - edit.html 코드 작성 
...
boards - templates - boards - edit.html 코드 수정 
...
boards - templates - boards - detail.html 코드 수정 
...
ex) /board/<id>를 /board/<id>/detail로 바꾸고자 할때 어떻게 하면 좋을까요?
...
boards - templates - boards - index.html 코드 수정 
...
boards - templates - boards - new.html 코드 수정 
