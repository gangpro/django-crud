...
- boards -views.py 코드 수정(방법 1)
  - [http://127.0.0.1:8000/boards/5/delete/](http://127.0.0.1:8000/boards/5/delete/) 처리하면 글이 삭제되는 현상이 있음 그러므로 REST 처리를 해서 GET이 아닌 POST 처리하게끔 만든다. 즉 url에 위와 같이 입력해도 삭제가 되지 않는다.
